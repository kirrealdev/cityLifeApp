...
#### 📲 Приложение на iPhone - гайд по уровням жизни в городах
...
## 📍Необходимо:📍
* Реализовать отображение по умолчанию информации о городе, в котором находится пользователь
* Реализовать сравнение двух городов
